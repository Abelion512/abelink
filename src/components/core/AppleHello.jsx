...
export function AppleHello({ durationScale = 0.8, onAnimationComplete, className = '' }) {
  const d1 = 0.8 * durationScale
  const d2 = 2.8 * durationScale
  const delay2 = 0.7 * durationScale
  const stroke = {
    strokeWidth: 14.8883,
    strokeLinecap: 'round',
  ...
  return (
    ...
    >
      <motion.path
        ...
        transition={{ duration: d1, ease: 'easeInOut' }}
      />
      <motion.path
        d={PATH2_D}
        stroke="currentColor"
        ...
        transition={{ duration: d2, delay: delay2, ease: 'easeInOut' }}
