...
export const BENCHMARK_MATRIX = [
  // ---- Coding / Terminal ----
  {
    ...
    note: 'Runner adaptasi TB-style dengan sentinel anti-cheat; sumbu arch vanilla|basic via --arch (default basic), nilai lain ditolak exit 2 (avo dihapus 2026-09-12, lihat benchArch.js); fixture per-run di <workspace-sidecar>/markbench-<runId>; upgrade verifikator ke skema TB 4.0 long-horizon menyusul.'
  },
  {
    id: 'swe-bench',
    layer: 'coding',
